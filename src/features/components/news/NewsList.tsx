        ...
        <div className="container-fluid pt-5">
            <div className="container">
                <div className="text-center pb-2">
                    <p className="section-title px-5"><span className="px-2">Actualités</span></p>
                    <h1 className="mb-4">Nos dernières activités</h1>
                </div>
                    ...
                    <div className="col-lg-4 mb-4">
                        <div className="card border-0 shadow-sm mb-2">
                            ...
                            <div className="card-body bg-light text-center p-4">
                                ...
                                <a href="" className="btn btn-primary px-4 mx-auto my-2">En savoir plus</a>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-4 mb-4">
